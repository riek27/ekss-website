...
export default function ContactPageClient({ data }: { data: any }) {
  ...
  const { hero, contactInfo, form, map, helpCards, faq, finalCta } = data;
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Form */}
            <div className="bg-soft-bg rounded-4xl p-8 shadow-xl fade-up fade-up-delay-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {helpCards.cards.map((card: any, i: number) => (
              <a key={i} href={card.link} className="fade-up card-hover bg-white rounded-3xl p-6 shadow-md border text-center block">
