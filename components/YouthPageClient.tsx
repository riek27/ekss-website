...
export default function YouthPageClient({ data }: { data: any }) {
  // Fade-up observer
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* YOUTH IN ACTION */}
      <section id="youth-in-action" className="py-20 bg-soft-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-deep-forest mb-4">{youthInAction.heading}</h2>
          <p className="text-gray-600 mb-12 max-w-3xl">{youthInAction.intro}</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {youthInAction.cards.map((card: any, i: number) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex gap-6 mb-8">
                {featuredInitiative.reachStats.map((stat: any, i: number) => (
                  <div key={i}>
      ...
      <section id="leadership-mentorship" className="py-20 bg-soft-bg">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-deep-forest mb-4">{leadershipMentorship.heading}</h2>
          <p className="text-gray-600 mb-10">{leadershipMentorship.intro}</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {leadershipMentorship.items.map((item: any, i: number) => (
