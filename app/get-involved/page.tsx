...
export default function GetInvolvedPage() {
  ...
  return (
    <>
      ...
      <section id="ways" className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ways.cards.map((card, i) => (
              <div
                key={i}
                className="card-hover bg-white rounded-3xl p-6 shadow-md border flex flex-col items-center text-center"
              >
                ...
                <a
                  href={card.ctaLink}
                  className="inline-flex items-center mt-4 text-emerald-green font-semibold text-sm hover:text-deep-forest transition-colors"
                >
                  {card.ctaText} →
                </a>
              </div>
      ...
      <section id="partner-with-us" className="py-20 lg:py-28 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {organizations.areas.map((area, i) => (
      ...
      <section className="py-20 lg:py-28 bg-soft-bg">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href={whyGetInvolved.ctaLink}
            className="inline-flex items-center gap-2 text-emerald-green font-semibold hover:text-deep-forest transition-colors"
          >
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {stories.list.map((story, i) => (
              <div key={i} className="card-hover bg-white rounded-3xl overflow-hidden shadow-md border">
                ...
                <div className="p-6">
                  ...
                  <a
                    href={story.link}
                    className="inline-flex items-center text-emerald-green font-semibold text-sm hover:text-deep-forest transition-colors"
                  >
                    Read More →
                  </a>
                </div>
      ...
      <section id="volunteer-form" className="py-20 lg:py-28 bg-soft-bg">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-deep-forest mb-8 text-center">
            {form.heading}
          </h2>
          {submitted ? (
            ...
            <form onSubmit={handleFormSubmit} className="bg-white rounded-3xl shadow-xl p-8 space-y-5">
              <div>
