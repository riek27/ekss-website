...
const sidebarLinks = [
  ...
  },
  {
    ...
    href: '/admin/empower-farmers',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-4l2.5 2.5m0 0l2-2m-2 2V9a4 4 0 00-4-4h-1a4 4 0 00-4 4v6.5L12 17z" />
      </svg>
    ),
  },
  {
