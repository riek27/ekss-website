          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => update('contactInfo.heading', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Address (line breaks allowed)</label>
              <textarea
            ...
            <div className="border-t pt-4 mt-4">
              ...
              <input
                value={data.contactInfo.executive.name}
                onChange={(e) => update('contactInfo.executive.name', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2 mt-1"
                placeholder="Name"
              />
              <input
                value={data.contactInfo.executive.title}
                onChange={(e) => update('contactInfo.executive.title', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2 mt-2"
                placeholder="Title"
              />
              <input
                value={data.contactInfo.executive.email}
                onChange={(e) => update('contactInfo.executive.email', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2 mt-2"
                placeholder="Email"
              />
            </div>
      ...
      case 'form':
        return (
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Subject Options (comma-separated)</label>
              <input
        ...
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Heading</label>
              <input
                value={data.map.heading}
                onChange={(e) => update('map.heading', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                onChange={(e) => update('map.description', e.target.value)}
                rows={3}
                className="w-full border border-gray-200 rounded-lg px-3 py-2"
              />
            </div>
            <div>
              ...
              <input
                value={data.map.mapUrl}
                onChange={(e) => update('map.mapUrl', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2"
              />
            </div>
            <div>
              ...
              <input
                value={data.map.directionLink}
                onChange={(e) => update('map.directionLink', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2"
              />
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Heading</label>
              <input
                value={data.helpCards.heading}
                onChange={(e) => update('helpCards.heading', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2"
              />
            </div>
            <h3 className="font-display font-bold text-lg text-deep-forest">Cards</h3>
            {data.helpCards.cards.map((card: any, i: number) => (
              <div key={i} className="border border-gray-200 rounded-xl p-4 bg-gray-50 space-y-3 mb-3">
                <input
                  value={card.icon}
                  onChange={(e) => {
                    const c = [...data.helpCards.cards];
                    c[i].icon = e.target.value;
                    update('helpCards.cards', c);
                  }}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2"
                ...
                <button
                  onClick={() =>
                    update(
                      'helpCards.cards',
                      data.helpCards.cards.filter((_: any, idx: number) => idx !== i)
                    )
                  }
            ...
            <button
              onClick={() =>
                update('helpCards.cards', [
                  ...data.helpCards.cards,
        ...
        return (
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Heading</label>
              <input
                value={data.finalCta.heading}
                onChange={(e) => update('finalCta.heading', e.target.value)}
                className="w-full border border-gray-200 rounded-lg px-3 py-2"
              />
            </div>
            <div>
